export const brevLanguage = {
  ...
  keywords: [
    "receive", "proclaim",
    "decree", "absolution", "edict",
    "discern", "verse", "grace",
    "absolve", "proceed", "fall",
    "procession", "endure", "ritual",
    "rite", "dismiss",
  ],

  types: ["sigil", "tally", "divine", "scripture", "hollow", "verity"],

  decl: ["sacred", "order", "ordain", "genesis"],

  builtins: ["verseof"],

  booleans: ["holy", "unholy"],
